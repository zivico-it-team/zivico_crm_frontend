...
const HeaderSection = ({
  ...
  return (
    <div className="mb-4 sm:mb-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 sm:text-base">
            Manage and resolve lead Compliance efficiently
          </p>
        </div>

        {/* Mobile/Tablet Action Buttons - Visible when menu is open */}
        {isMobileMenuOpen && (
      ...
      {/* Tablet Quick Actions - Visible on medium screens */}
      <div className="hidden mt-3 lg:hidden md:flex md:gap-2">
        <button
          onClick={onResetFilters}
        ...
        <button className="flex items-center justify-center flex-1 gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
          <svg
            className="w-4 h-4"
            fill="none"
            stroke="currentColor"
